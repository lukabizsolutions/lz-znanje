...
export const BOOKS = [
  { id: 'atomic-habits',       title: 'Atomske navike',                          author: 'Džjms Klir',       year: 2024, palette: ['#E8C547','#1C1C1C'], finished: true,  pages: 320, progress: 100 },
...
export const LESSONS = [
  { id: 'l1',  tag: 'navike',     title: 'Okruženje pobedjuje volju.',                  body: 'Najpouzdaniji način da izgradis naviku je da dizajniras znakove u svom fizičkom prostoru. Volja je ograničen resurs; vidljiv znak ne košta ništa.',                                                         source: { kind: 'book',     id: 'atomic-habits',     label: 'Atomske navike' } },
  ...
  { id: 'l10', tag: 'pisanje',    title: 'Pisanje je mišljenje koje je postalo vidljivo.',          body: 'Ako ne možeš jasno da napišeš, ne razumeš. Koristi stranicu da preispitaš sopstvenu ideju pre nego što je brаниš.',                                                                source: { kind: 'notebook', label: 'Sveska · Pisanje' } },
  ...
  { id: 'l13', tag: 'fokus',      title: 'Ostatak pažnje je porez na kontekst.',                   body: 'Svako prebacivanje izmedju zadataka ostavlja fragment prethodnog. Dva sata fragmentisanog rada nije jednako dva sata dubokog rada.',                                                                                          source: { kind: 'book',     id: 'deep-work',         label: 'Dubok rad' } },
  ...
  { id: 'l16', tag: 'psihologija',title: 'Prepreka je put.',                                            body: 'Svaka prepreka sadrži oblik puta kroz nju. Stoički potez je da se otpor metaboliše u gorivo.',                                                                                                                 source: { kind: 'book',     id: 'obstacle-way',      label: 'Prepreka je put' } },
...
export const IDEAS = [
  { id: 'i1', title: 'Mikro-kurs o pregovaranju za developere',     tag: 'proizvod',  cover: ['#2B4C7E','#FFD23F'], date: '12. apr 2026', body: '3x15 min video lekcija - jedna knjiga po lekciji. Prva: Voss. Druga: Mnookin. Treća: moja sinteza. Naplatiti 29 EUR. Testirati na LinkedIn publici.' },
  ...
  { id: 'i5', title: 'Radionica: dizajn okruženja',              tag: 'navike',    cover: ['#E8C547','#1C1C1C'], date: '20. mar 2026', body: 'Dvočasovna radionica - učesnici mapiraju svoj radni prostor, identifikuju 3 trenja i 3 znaka. Plaća se 49 EUR, grupa do 10. Prvi pilot sa kolegama iz konsaltinga.' },
...
export const VIDEOS = [
  ...
  { id: 'v2', title: 'Moj sistem za vodjenje beleški',         duration: '18:05', date: '10. apr 2026', tag: 'sistemi',    cover: ['#2B4C7E','#F4EFE6'], views: 238, description: 'Showcase celog toka - od markera u knjizi, do digitalne kartice u LZ, do kvartalnog pregleda. Tri pravila koja sam iskristalisao za tri godine.' },
  ...
  { id: 'v6', title: 'Tiha nedelja: bez ekrana nedelju dana',      duration: '21:47', date: '05. mar 2026', tag: 'fokus',      cover: ['#F5F0E3','#1C1C1C'], views: 198, description: 'Eksperiment - nedelju dana bez telefona i društvenih mreža. Šta se desilo s pažnjom, snom, raspoloženjem. Iskreni zaključak sa brojevima.' },
];
...
export const BOOK_DETAILS = {
  'atomic-habits': {
    ...
    lessons: [
      { id: 'bl1', tag: 'navike',    title: 'Identitet prethodi ponašanju.',      body: 'Ne odlukuješ da trčiš; odlučuješ da budeš trkač. Pomak identiteta se ukamaćuje. Svako ponavljanje je glas za osobu koja postaješ - i glačaka kutija se ne zatvara.' },
      ...
      { id: 'bl3', tag: 'identitet', title: 'Plato latentnog potencijala.',            body: 'Linearan ulaz, nelinearan izlaz. Razmak izmedju očekivanja i napretka je gde većina odustaje. Rezultati stizu kasno; rad to ne sme.' },
    ],
    notes: 'Svakog januara ponovo čitam poglavlje o petlji navika. Spoj sa kvartalnim pregledom - mapirati svaku naviku na identitet koji pojačava. Najveći propušt prošle godine: znakovi u radnom kabinetu nisu bili dovoljno vidljivi. Štampao sam ček-listu na zidu za Q2.\n\nDiskusija kluba 18. mart: grupa se podelila oko toga da li je okvir baziran na identitetu precenjen. Ne slažem se - bihejvioralno uvezbavanje JESTE identitet.',
    summary: {
      paragraphs: [
        'Džjms Klir tvrdi da smislena promena ne dolazi iz postavljanja ambicioznih ciljeva već iz dizajna malih, doslednih sistema. Knjiga preformuliše navike kao složenu kamatu samousavršavanja - svaka sitna akcija je sama po sebi nebitna, ali kumulativni povrat je definišuća varijabla života.',
        'Centralni okvir je Četiri zakona promene ponašanja - učini ih očiglednim, privlačnim, lakim i zadovoljavajućim - primenjeni obrnuto za prekid loših navika. Ispod taktika teče dublja tvrdnja: da trajna promena proižilazi iz identiteta, ne iz ishoda.',
      ],
      ideas: [
        ...
        { title: 'Dizajn okruženja pobedjuje samodisciplinu.', body: 'Većina takozvanih disciplinovanih ljudi je jednostavno učinila loše navike nepraktičnim, a dobre očiglednim. Znakovi rade posao koji volja ne može.' },
        { title: 'Slaganje navika.',                               body: 'Zakači novu naviku za postojeću. "Nakon što sipam jutarnju kafu, pišem dvadeset minuta" pobedjuje svaki kalendarski podsetnik.' },
  ...
  'deep-work': {
    ...
    summary: {
      paragraphs: [
        'Kal Njuport iznosi dvostruki argument: da sposobnost fokusa bez distrakcije na kognitivno zahtevnim zadacima postaje retka u ekonomiji, i istovremeno sve vrednija. Rastući jaz izmedju ove dve krive, tvrdi on, je najvažnija karijerna prilika našeg vremena.',
        'Druga polovina je preskriptivna - skup rituala, pravila i taktika zakazivanja za zaštitu dubokog rada u radnom okruženju optimizovanom za plitku distrakciju. Njuport je skeptičan i prema društvenim mrežama i prema kulturi sastanaka-kao-produktivnosti.',
      ],
      ideas: [
        ...
        { title: 'Zakaži svaki minut.',       body: 'Blokiranje vremena te tera da se suočiš s tim kako zaista trošiš sate naspram kako zamisšljaš da ih trošiš. Razlika je obično brutalna.' },
        { title: 'Fiksno zakazana produktivnost.', body: 'Tvrd kraj u 17:30 nije ograničenje - to je funkcija koja te tera da biraš. Hitnost izоštrava prioritete bolje od bilo kog okvira.' },
        { title: 'Napusti društvene mreže, uslovno.', body: 'Trideset dana pauze, pa se pitaj da li je povratak vredeo cene pažnje. Većina alata ne prolazi test.' },
      ],
...
export const NOTEBOOK_ENTRIES = [
  ...
  { id: 'n4', title: 'Sistem za "probudi se sa strahom"',      tag: 'psihologija',date: '28. mar 2026', body: 'Ako se probudim sa osećajem da nešto nije uredu, prvo pitanje: da li je to telo (hrana/san/kafa) ili um (stvarno pitanje)? 80% vremena - telo.' },
  ...
  { id: 'n8', title: 'Kad prestanem da čitam knjigu',     tag: 'odluke',     date: '01. mar 2026', body: 'Pravilo od 50 strana izgleda dobro - ali mislim da stvarni signal nije broj strana. Ako posle 50 strana ne mislim o knjizi izmedju sesija, odlažem.' },
];
...
export const BOOKS_THIS_YEAR = 18;
export const PAGES_TODAY = 42;
export const STREAK_DAYS = 11;
export const CURRENT_STREAK_LABEL = '11 dana zaredom';
export const THIS_MONTH_BOOKS = ['obstacle-way', 'range', 'creative-act', 'build'];
...
export const T = {
  ...
  common: {
    ...
    videosSubtitle: 'Tvoji snimci - uvek su sa tobom. Klikni da pogleдaш.',
